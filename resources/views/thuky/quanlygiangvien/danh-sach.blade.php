...
@section('body')
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="{{action('App\Http\Controllers\thuky\GiangVienController@getViewDanhSach')}}">Danh
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="d-flex">
                <div class="pb-1 me-2">
                    <a href="{{action('App\Http\Controllers\thuky\GiangVienController@getViewThem')}}" type="button"
    ...
    <script>
        $(document).ready(function () {
            $('.btnXoa').click(function () {
                ...
                $.ajax({
                    url: '{{action('App\Http\Controllers\thuky\GiangVienController@deleteGiangVien')}}',
                    type: "DELETE",
                    data: {
                        '_token': "{{ csrf_token() }}",
                        'idGV': id,
        ...
        $('.btnExcel').click(function(){
            ...
            $('.luuTT').click(function(){
                ...
                $.ajax({
                    url: '{{ action('App\Http\Controllers\thuky\GiangVienController@postImportGiangVien') }}',
                    type: "POST",
                    headers: {
