...
class GiangVienController extends Controller
{
    public function getViewDanhSach()
    {
        ...
        $data = $gv->danhSach();
        return view('thuky.quanlygiangvien.danh-sach',['dsgv' => $data]);
    }
    ...
    public function getViewThem()
    {
        ...
        $dv = $model->danhSach();
        return view('thuky.quanlygiangvien.them',['dv' => $dv]);
    }
    ...
    public function getViewCapNhat($id_giang_vien, Request $request)
    {
        ...
        $model = new DonViModel();
        $dv = $model->danhSach();
        return view('thuky.quanlygiangvien.cap-nhat',['ct' => $gv->chiTiet()], ['dv' => $dv]);
    }

    public function getViewXoa()
    {
        return view('thuky.quanlygiangvien.xoa');
    }
